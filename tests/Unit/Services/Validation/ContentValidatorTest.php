...
final class ContentValidatorTest extends TestCase
{
    ...
    public function test_validates_valid_legal_text_file(): void
    {
    ...
    public function test_validates_english_legal_content(): void
    {
    ...
    public function test_rejects_content_too_short(): void
    {
    ...
    public function test_rejects_content_too_long(): void
    {
    ...
    public function test_validates_pdf_placeholder(): void
    {
    ...
    public function test_validates_docx_placeholder(): void
    {
    ...
    public function test_rejects_invalid_pdf(): void
    {
    ...
    public function test_rejects_invalid_docx(): void
    {
    ...
    public function test_supports_only_allowed_extensions(): void
    {
    ...
    public function test_detects_encoding(): void
    {
    ...
    public function test_calculates_quality_metrics(): void
    {
