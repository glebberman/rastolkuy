...
final class FileSizeValidatorTest extends TestCase
{
    ...
    public function test_validates_file_within_size_limits(): void
    {
    ...
    public function test_warns_about_large_files(): void
    {
    ...
    public function test_handles_false_file_size(): void
    {
