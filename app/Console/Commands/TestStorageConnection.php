    ...
    public function handle(): int
    {
        ...
        try {
            ...
            if (!$fileStorageService->exists($testFileName)) {
                throw new RuntimeException('File existence check failed');
            }
            ...
            if ($retrievedContent !== $testContent) {
                throw new RuntimeException('Content mismatch - read operation failed');
            }
            ...
            if ($size !== $expectedSize) {
                throw new RuntimeException("Size mismatch: expected {$expectedSize}, got {$size}");
            }
            ...
            if (!$fileStorageService->exists($copyFileName)) {
                throw new RuntimeException('Copied file does not exist');
            }
